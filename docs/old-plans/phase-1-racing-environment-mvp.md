# Archived Project Plan — Phase 1: Racing Environment MVP
...
1. “Fully functioning physics simulation” means the version-0 kinematic model
   specified in [`docs/MDP.md`](../MDP.md), not a complete vehicle-dynamics
   simulator.
...
- [`docs/MDP.md`](../MDP.md) for state, action, dynamics, reward and episode
  lifecycle;
- [`docs/TRACK.md`](../TRACK.md) for track geometry, persistence, Frenet
